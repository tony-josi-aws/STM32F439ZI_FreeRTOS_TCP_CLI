 ...
 */
            traceResult xTraceMultiCoreEventBufferInitialize( TraceMultiCoreEventBuffer_t * const pxTraceMultiCoreEventBuffer,
                                                              uint32_t uiOptions,
                                                              uint8_t * puiBuffer,
                                                              uint32_t uiSize );
 ...
 * @retval TRC_SUCCESS Success
 */
                traceResult xTraceMultiCoreEventBufferAlloc( const TraceMultiCoreEventBuffer_t * const pxTraceMultiCoreEventBuffer,
                                                             uint32_t uiSize,
                                                             void ** ppvData );
 ...
 * @retval TRC_SUCCESS Success
 */
                traceResult xTraceMultiCoreEventBufferAllocCommit( const TraceMultiCoreEventBuffer_t * const pxTraceMultiCoreEventBuffer,
                                                                   void * pvData,
                                                                   uint32_t uiSize,
