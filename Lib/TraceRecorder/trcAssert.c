...
/*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress basic char type usage*/
                                       ...
                                       TraceUnsignedBaseType_t uxLineNumber )
            {
                ...
                if( uxRecursionGuard == 0u )
                {
                    ...
                    {
                        /* Find length */
                        for( i = 0; ( szFilePath[ i ] != ( char ) 0 ) && ( i < 128 ); i++ )
                        {
                        }                                                /*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress basic char type usage*/ /*cstat !MISRAC2004-17.4_b We need to access every character in the string*/
                        ...
                        {
                        }                                                                                  /*cstat !MISRAC2004-17.4_b We need to access every character in the string*/
