...
/*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress basic char type usage*/
                                           ...
                                           TraceEntryHandle_t * pxEntryHandle )
        {
            ...
            *pxEntryHandle = ( TraceEntryHandle_t ) &pxEntryTable->axEntries[ index ];
            ...
            traceResult xTraceEntryCreateWithAddress( void * const pvAddress,
                                                      TraceEntryHandle_t * pxEntryHandle )
            {
                /* This should never fail */
                TRC_ASSERT( pvAddress != ( void * ) 0 );
            ...
            traceResult xTraceEntrySetState( const TraceEntryHandle_t xEntryHandle,
                                             TraceUnsignedBaseType_t uxStateIndex,
            ...
            traceResult xTraceEntrySetOptions( const TraceEntryHandle_t xEntryHandle,
                                               uint32_t uiMask )
            {
                /* This should never fail */
                TRC_ASSERT( xTraceIsComponentInitialized( TRC_RECORDER_COMPONENT_ENTRY ) );
            ...
            traceResult xTraceEntryClearOptions( const TraceEntryHandle_t xEntryHandle,
                                                 uint32_t uiMask )
            {
                /* This should never fail */
                TRC_ASSERT( xTraceIsComponentInitialized( TRC_RECORDER_COMPONENT_ENTRY ) );
            ...
            traceResult xTraceEntryGetAddress( const TraceEntryHandle_t xEntryHandle,
                                               void ** ppvAddress )
            {
                /* This should never fail */
                TRC_ASSERT( xTraceIsComponentInitialized( TRC_RECORDER_COMPONENT_ENTRY ) );
...
/*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress basic char type usage*/
            traceResult xTraceEntryGetSymbol( const TraceEntryHandle_t xEntryHandle,
            ...
            traceResult xTraceEntryGetState( const TraceEntryHandle_t xEntryHandle,
                                             TraceUnsignedBaseType_t uxStateIndex,
...
/*cstat !MISRAC2012-Rule-8.13 Suppress const check for xEntryHandle*/
            TraceUnsignedBaseType_t xTraceEntryGetStateReturn( const TraceEntryHandle_t xEntryHandle,
                                                               TraceUnsignedBaseType_t uxStateIndex )
            {
                return TRC_ENTRY_GET_STATE_RETURN( xEntryHandle, uxStateIndex );
            }

            traceResult xTraceEntryGetOptions( const TraceEntryHandle_t xEntryHandle,
                                               uint32_t * puiOptions )
            {
                /* This should never fail */
                TRC_ASSERT( xTraceIsComponentInitialized( TRC_RECORDER_COMPONENT_ENTRY ) );
