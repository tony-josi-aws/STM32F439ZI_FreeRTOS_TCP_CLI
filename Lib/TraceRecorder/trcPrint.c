...
#include <trcRecorder.h>
            ...
            static traceResult prvTraceVPrintF( const TraceStringHandle_t xChannel,
                                                const char * szFormat,
                                                uint32_t uiLength,
                                                uint32_t uiArgs,
                                                va_list * const pxVariableList );
...
/*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress basic char type usage*/
                                     ...
                                     const char * szString )
            {
                ...
                for( i = 0u; ( szString[ i ] != ( char ) 0 ) && ( i < 128u ); i++ )
                {
                }                                                                            /*cstat !MISRAC2004-6.3 !MISRAC2012-Dir-4.6_a Suppress char base type usage checks*/ /*cstat !MISRAC2004-17.4_b We need to access every character in the string*/
