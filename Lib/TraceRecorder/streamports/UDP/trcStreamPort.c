...
/* UDP includes - for lwIP in this case */
        ...
        static int32_t prv_udp_send( void * pvData,
                                     uint32_t uiSize,
                                     int32_t * piBytesWritten );
        static int32_t prv_udp_recv( void * pvData,
                                     uint32_t uiSize,
                                     int32_t * piBytesRead );
        ...
        static void prv_udp_recv_callback( void * arg,
                                           struct udp_pcb * pvPCB,
                                           struct pbuf * pvBuf,
...
/************** MODIFY THE ABOVE PART TO USE YOUR UDP STACK ****************/
        ...
        int32_t prvTraceUdpWrite( void * pvData,
                                  uint32_t uiSize,
                                  int32_t * piBytesWritten )
        {
            prv_connect_pcb();
        ...
        int32_t prvTraceUdpRead( void * pvData,
                                 uint32_t uiSize,
                                 int32_t * piBytesRead )
        {
            prv_bind_pcb();
